...
class CocktailsControllerTest < ActionController::TestCase
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post :create, cocktail: { descripcion: @cocktail.descripcion, nombre: @cocktail.nombre, precio: @cocktail.precio }
    end
  ...
  test "should update cocktail" do
    patch :update, id: @cocktail, cocktail: { descripcion: @cocktail.descripcion, nombre: @cocktail.nombre, precio: @cocktail.precio }
    assert_redirected_to cocktail_path(assigns(:cocktail))
  end
